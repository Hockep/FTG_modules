#.ll <реплай на фото или стикер>
#╰отражает левую часть
#.rr <реплай на фото или стикер>
#╰отражает правую часть
#.uu <реплай на фото или стикер>
#╰отражает верхнюю часть
#.dd <реплай на фото или стикер>
#╰отражает нижнюю часть
#
#Стикер отправляет как стикер
#Чтобы отправить стикер как фото после команды напиши что-то из: i, im, ima, imag, image
#
#Фото отправляет как фото
#Чтобы отправить  фото как стикер после команды напиши что-то из: s, st, sti, stic, stick, sricke, sticker
#
#СРЁТ В РЕСЕНТЫ
